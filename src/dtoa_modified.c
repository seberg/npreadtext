...
//
// This file is now called dtoa_modified.c.  It was copied from the
// source code for Python 3.8.3, and modified by Warren Weckesser.
//
// o The function _Py_dg_strtod has been cleverly renamed
//   to _Py_dg_strtod_modified
// o The `char` type of the arguments to _Py_dg_strtod_modified were
//   changed to char32_t.
// o _Py_dg_strtod_modified has the additional arguments
//      int *perror, char32_t decimal, char32_t sci, bool skip_trailing
//
